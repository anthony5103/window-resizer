...
- **Customizable Grid**: Configure grid patterns from 1x1 to 8x8 (rows x columns)
- **Visual Grid Selection**: Click and drag to select grid squares visually
...
3. **Configure Grid**:
   - Use the steppers in the popover to set custom rows and columns (default: 2x2)
...
- Select column A, rows 1 and 2 (the two left squares)

**Full Left Column (4x4 grid)**:

- Select column A, rows 1, 2, 3, and 4
